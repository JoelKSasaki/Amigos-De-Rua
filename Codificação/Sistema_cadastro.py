...
#mostra o número de telefone e o nome do dono
if numero_tel != "":
    print(f'Nome do dono: {dados_dono["Nome dono"]} | Telefone: {dados_dono["Numero telefone"]}')
        ...
        def perg_idade():
            ...
            while Verdade == False:
                try:
                    ...
                    if idade_anos > 0 and idade_meses > 0:
                        Verdade = True
                    else:
